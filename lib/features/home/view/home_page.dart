...
String? resolveTemplateCode({
  ...
  const map = {
    ...
    'ФОРМАКС|ИП с 2017|ЛД|Постоянный': 'fm_ld_ip_s_2017',
    'ФОРМАКС|ИП с 2017|ЛД|Постоянный, сезонный': 'fm_ld_ip_s_2017_POST',
    'ФОРМАКС|ИП с 2017|ЛД|Сезонный': 'fm_ld_ip_s_2017_s',
    // ФОРМАКС — ДС
    'ФОРМАКС|ООО|ДС': 'fm_ds_ooo',
    'ФОРМАКС|ИП до 2017|ДС': 'fm_ds_ip_do_2017',
    'ФОРМАКС|ИП с 2017|ДС': 'fm_ds_ip_s_2017',
    // ФОРМАКС — СОР
